<?php
class PostProductCreateView extends View{
		    ...
		    <div class="col-md-7">
		    	<div class="card">
				  <div class="card-header">
				   	<h2 class="text-center text-white">New Post Product</h2>
				  </div>
				  <div class="card-body">
				    <form class="m-2">
					...
					<div class="form-group">
					  ...
					  <button type="submit" class="btn btn-primary btn-lg btn-block rounded-pill font-weight-bold">CREATE</button>
					</form>
				  </div>
				</div>
		   	 </div>
