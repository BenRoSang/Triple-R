<?php
class SupplierLoginView extends View
{
	private $errors;
				    ...
				    <p class="card-text">
				    	<form class="m-2" method="post">
					  		<div class="form-group m-0">
					    		...
					    		<input type="text" name="l_email" class="form-control  form-control-sm rounded-pill" id="InputEmail1" aria-describedby="emailHelp" value="<?php echo @$_POST['l_email'];?>" >
					    		<font color="red">
									<?php
										if(isset($this->errors["lemail_null"]))
											echo $this->errors["lemail_null"];
									?>
								</font>
					 		</div>
					  		<div class="form-group">
					    		<label for="InputPassword" class="text-muted">Password</label>
					    		<input type="password" name="l_password" class="form-control  form-control-sm rounded-pill" id="InputPassword" value="<?php echo @$_POST['l_password'];?>">
					    		<font color="red">
									<?php
					  		...
					  		<div class="text-center">
					  			<input type="submit" name="btnSupplierLogin" class="btn btn-color rounded-pill text-white" value="SIGN IN">
