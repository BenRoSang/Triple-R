<?php
class SupplierForgetPasswordView extends View{
			...
			<div class="card-body">
				...
				<form class="m-2" method="post">
					...
					<div class="text-center">
							<input type="submit" name="btnRequestPassSuppplier" class="btn btn-color rounded-pill" value="REQUEST">
						
							<a class="btn btn-secondary text-white rounded-pill" href="index.php?usecase=<?php echo UC_SUPPLIER_LOGIN?>&user_type=1">CANCEL</a>
					</div>
					<!-- <button type="submit" class="btn btn-primary btn-block rounded-pill font-weight-bold" name="btnRequestPassSuppplier">Request</button> -->
				</form>				
			</div>
		</div>
	</div>
